...
hero:
  ...
  actions:
    - text: Get Started
      ...
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/anthropics/ont
      icon: external
      variant: minimal
---
...
3. Humans approve any changes to the topology (the shape of your business)

The topology is your operational DNA. AI writes code, but only humans change what the business *is*.
...
<CardGrid stagger>
  ...
  <Card title="Human-in-the-Loop" icon="approve-check">
    Topology changes require human approval. AI builds the logic, but only humans change what the business *is*.
  </Card>
  <Card title="MCP Integration" icon="puzzle">
    Functions are automatically exposed as MCP tools. AI agents see only what they're allowed to call.
  </Card>
